...
| T7 | 장비 화면 = Character_Hero_Equipment 그대로 + 장착 외형 반영 + ListItem_EquipMent + 상점·합성 버튼은 스탯 3칸 아래 | ✅ 완료 (`ff53ebb` · 실물 확인은 WebGL 배포에서) | sess-2036-27996 / 워커 C | Core/GearLook(신규) · Game/GearScreen · GearUi · CharacterRig · BattleWorld(스킨) · HeroView(T6 것 재사용) · Tests/GearLookTests | 프리팹 요소 이동 0 · 슬롯 Item 크기 그대로 · 파츠 36종 표 · dotnet 0/0 · 테스트 45/45 |
...
| T13 | 웨이브 출발 버그(연출) · 버프 스택 = 팔각 프레임 — T12 뒤 | 대기 | — | Game/BattleWorld · BattleScreen | ROUTINE §2 T13 |
| T14 | 투사체 표적 = 웨이브 안 무작위(원본 sim.js 확인 후) — T13 뒤 | 대기 | — | Core/Battle · Game/BattleWorld | ROUTINE §2 T14 |
| T15 | 모든 버튼 눌림 표시(ColorTint) | 대기 | — | Game/UiKit · Screens(NavBar) | ROUTINE §2 T15 |
| T16 | 쉼터 «광고 보고 둘 다» · 클리어 = 골드만 + «광고 보고 보상 ×2» — T14 뒤 | 대기 | — | Game/Overlay · BattleScreen · Core/Battle(ResolveRestBoth) | ROUTINE §2 T16 |
| T17 | 장비 아이콘 마무리 — 파츠 아이콘 크기 통일 · 무기 45° · 근접 무기(검·방망이)만 — T7 뒤 | 대기 | — | Game/GearUi · GearScreen · GearLook · catalog | ROUTINE §2 T17 |
| T18 | 배속(x2) 기억 — 세이브 필드 | 대기 | — | Game/BattleScreen · SaveStore | ROUTINE §2 T18 |
| T19 | 전투 맵 = 데모 씬 그림 그대로(0.6배 · 물결 양쪽 · 밀도) — T13 뒤 · T14 앞 | 대기 | — | Game/BattleWorld · tools/gen_maps · MapLayouts | ROUTINE §2 T19 |
