...
| prefabs | `ui.profileAvatar` | `Assets/Layer Lab/GUI Pro-MinimalGame/Theme_Light/Prefabs/Prefabs~DemoScenes/Social_Profile_Avatar.prefab` | root 3223506120641057420 | 프로필 «아바타 고르기» 팝업(T96-profile · 주인 지목 Social_Profile_Avatar 그대로) — 칸 6개 중 다섯에 우리 색을 배정하고 남는 칸은 끈다 |
