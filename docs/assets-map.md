...
| sprites | `fr.pillBorder` | `Assets/Layer Lab/GUI Pro-MinimalGame/Shared/Sprite_Common/Frame/BasicFrame/BasicFrame_Rectangle_05_White_Border.png` | guid 3cf89f4959c424b76bee0c14e4c91472 · fileID 21300000 | T69-lobby pill(캡슐) 테두리 — 상단 재화 pill(골드·보석 · TopBar) · 전투 HUD pill 2(처치 수·이번 판 골드) · 87×39 9-slice(border 44/20/43/19 = 가운데 0 → 가로로 늘리면 캡슐) · 선 7px → 프레임 8px(결정 154) |
