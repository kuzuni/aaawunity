...
- **(2026-09-07 · 00:4X UTC) ⚑⚑ 주인 지시 — 로비 정리: 7일 챌린지 삭제 · 스타터팩 버튼 삭제 · 시즌 패스 삭제 · 성 버튼 삭제 · 퀘스트 팝업은 GUI Pro `Progression_Mission_02` 프리팹으로 교체.** → **T78** 등재(§2 · 왼쪽 기둥 = 특권 1칸 · 배너 자리 비움 · 로비 묶음 워커가 잡는다).
