...
### T71 — 전투 맵 3건 + 장비 무대 도로(주인 2026-09-06 · T19 «데모 씬 그대로» 일부 뒤집음): ① 길 아래쪽 `Road_up_*` 물결 경계는 **y축 반전** ② 나무·소품을 위·아래 **골고루** ③ 장비 화면 무대에 `Road_up_DeepForest` 류 물결 경계 넣기 (T19·T37 뒤 · 제약 없음) — **🔄 코드 `e2366b5`(워커 E · ① flipY + 위 경계의 길 중심 대칭 자리 ② 원인 = 정렬(위쪽 소품 하한 −60 < 바닥 −20 → y ≥ 2.46 나무가 바닥 뒤로 숨음) → 정렬 층 상수로 · 표는 데모 그대로 · 미러 배치 없음 · 게이트 비 0.5~2.0(결정 160) ③ 장비 무대 RoadUp/RoadDown 타일 줄 · 확인 = 그 CI 의 `MapThemeTests`·`UiSmokeTests` ② + screens 02/03/06 · PROGRESS T71 진행 기록)**
