...
### T127 — 순위 보상 팝업(25) **하단 탭 두 개가 팝업 밑변 밖으로 넘친다** (`screens` run 243 눈 확인 · 워커 C 실측 등재 2026-09-07 02:5X · 화면만 · 배치 표 불변) — **🔄 코드 push(sess-2041-14225 · 워커 C · 로컬 게이트 전부 초록) · 남은 일 = 확인뿐**
...
### T128 — 던전(20) 원정 카드의 **«획득 가능» 칸이 전부 초록** (레퍼런스는 물건마다 색이 다르다) (`screens` 눈 확인 · 워커 C 실측 등재 2026-09-07 03:0X · 화면 색만 · 배치 표 불변) — **🔄 코드 push(sess-2041-14225 · 워커 C · 로컬 게이트 전부 초록) · 남은 일 = 확인뿐**
