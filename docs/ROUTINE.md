...
### T78 — 로비 정리(주인 2026-09-07): **삭제** = 7일 챌린지(18) · 스타터팩 버튼 · 시즌 패스(배너 + 19 팝업) · 성 버튼 / **교체** = 퀘스트 팝업(15) → GUI Pro **`Progression_Mission_02`** 프리팹 (T44·T68 뒤 · 로비 파일 = T63/T68/T69/T72 로비 묶음과 같은 워커)
