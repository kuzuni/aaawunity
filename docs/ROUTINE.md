...
### T17 — 장비 아이콘 마무리 (투구·갑옷·무기 크기 · 무기 45° · 근접 무기만) (T7 뒤) 🔄 진행중 (코드 `6918f71`+`8c8d60e` CI #43 초록 · 갱신 반영 `ec1a91a` · CI #47 대기 · PROGRESS 참조)
...
### T36 — 레벨업 3택 · 보유 특전 팝업 = `04_perks.jpg`·`05_perks_list.jpg` 구도
...
### T37 — 장비 화면 = `06_gear.jpg` 구도 (T17 뒤 · T25 흡수)
...
### T38 — 장비 세부 팝업 = `07_gear_detail.jpg` 구도 (T37 뒤 · T27 대체)
...
### T39 — 대장간 = `08_gear_fuse.jpg` 구도 (T37 뒤)
범위: `Assets/Scripts/Game/ForgeScreen.cs`
...
### T40 — 상점 = `09_shop_1.jpg`·`10_shop_2.jpg` 구도
...
### T41 — 설정 팝업 = `12_settings.jpg` 구도 (T29 뒤)
...
### T42 — 펫 탭 = `13_pet.jpg` 구도 + 펫 세부 = `14_pet_detail.jpg` (껍데기 · T32 대체)
...
### T43 — 던전 탭 = 던전 `20`·`21` + 아레나 `22`~`26` 껍데기 (T30 대체)
...
### T44 — 로비 사이드 팝업 껍데기 6종 = `11`·`15`·`16`·`17`·`18`·`19` (T34 뒤)
