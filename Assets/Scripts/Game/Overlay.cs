...
namespace KkomaKnight.Game
{
    ...
    public sealed class Overlay
    {
        ...
        /// <b>T234 — 90 → 76.</b> 레퍼런스는 «위로 퍼지는 부드러운 부채» 인데 우리는 «가운데가 꽉 찬 진한 원반» 이었다.
        /// 조각(광선 수·모양)은 그대로 두고(주인 상시 규칙 «그림이 안 비슷한 것은 감점 아님» · 3항 ⓒ) <b>크기와 짙기</b>만 만진다 —
        /// 같은 조각이 1.15배 넓은 자리에 옅게 깔리면 원반보다 부채에 가깝다. 빛살 기본값(68/255)보다는 여전히 진하다.
        /// </summary>
        public const float TitleGlowAlpha = 76f / 255f;
