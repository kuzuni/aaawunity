namespace KkomaKnight.Core
{
    ...
    public static class Layout
    {
        ...
        /// <summary>
        /// 컨페티 한 장 — 채도 높은 알갱이가 <b>위 81%</b> 에 흩어진다(아래 19%는 비어 있다 · 표 ㊻ 실측 · T384).
        /// <para>어둠 바로 «위» · 엠블럼보다 «아래» 다 — 이 한 장이 화면 위쪽을 통째로 덮으므로 <b>클릭을 안 먹어야</b> 한다(«계속» 버튼이 그 아래 y76.7 에 있다).</para>
        /// </summary>
        public static readonly R ArrConfetti = new R(0f, 0f, 100f, 81f);
