...
namespace KkomaKnight.Tests
{
    ...
    /// </para>
    /// <b>값도 들어왔다</b>(주인 2026-09-08 09:4X «1등 다이아 3000개 2등 2500개 3등 2300개 이런 식으로 줘 · 꼴등은 한 500 정도») —
    /// 자는 <b>값을 베끼지 않는다</b>(결정 555): 주인이 입으로 말한 <b>네 자리만</b> 못 박고, 나머지 열둘은 «위로 갈수록 많이 받는다»(단조 감소) 규칙으로 지킨다.
    /// </summary>
